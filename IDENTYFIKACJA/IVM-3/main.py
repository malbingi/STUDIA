...
def main():
    search_space = s.Space(optimization_target, epsilon, 10)
    ...
    while iteration < n_iterations or search_space.gbest_value < epsilon:
        ...
        saveToFile(search_space.gbest_value, "main18.csv")
        saveToFile(search_space.gbest_position, "coordinates18.csv")
